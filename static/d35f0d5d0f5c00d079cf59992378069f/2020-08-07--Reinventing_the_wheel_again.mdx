...
Miałem już kilka podejsc do tworzenia sobie strony, i za każdym razem kończyło się to jakaś formą niepowodzenia --
...
Koniec końców skończyło się na tym co widać (a przynajmniej było widać w dniu publikacji).
Jesli widzisz podobieństwo do [bloga Comandeera](https://blog.comandeer.pl/), to jest ono słuszne,
ponieważ nie ukrywam, że trochę się nim sugerowałem. Nie jest to jednak jedyna inspiracja --
spogladałem również na [devstyle.pl](https://devstyle.pl/) oraz na świeżo założoną [Postać normalną](https://postacnormalna.pl/).

Jednakowoż to nie koniec. Teraz najważniejszym dla mnie było stworzyć miejsce w które mógłym zwyczajnie wrzucać treść.
Dość prawdopodobne, że to jak to wyglada będzie się sukcesywnie zmieniać.
Tym bardziej jestem tego pewien, ponieważ mam kolejne pomysły jak mógłym ulepszyć wygląd.