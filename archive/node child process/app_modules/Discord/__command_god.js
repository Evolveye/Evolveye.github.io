module.exports = { "god" : {
  ...
  delete(mask={ count:/^\d+$ /}, role='God', desc='Usuń określoną ilość ostatnich wiadomości') {
  ...
  reload(role='God', desc='Przeładuj polecenia i funkcje pośrednie') {
